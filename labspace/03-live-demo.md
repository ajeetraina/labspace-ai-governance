...
Define policies in the Admin Console, watch them flow to your developer machine, and prove enforcement with three `curl` commands inside a sandbox.
...
Move on to Section 04 for a preview of audit trails and MCP governance.
