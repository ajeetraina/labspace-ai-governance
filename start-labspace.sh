...
# (workspace.provider.type: labspace in compose.override.yaml). The provider
# takes care of the terminal — this script just checks for sbx and brings up
# the compose stack.
#
...
#
#   If sbx is missing, this script will tell you how to install it.
...
# ── 5. Start Labspace (use local base compose if present, ───────
